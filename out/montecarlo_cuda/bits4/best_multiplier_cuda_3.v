...
module multiplier (
    ...
    wire [3:0] columna5 = pp2 + pp12 + pp16;
    wire [3:0] columna4 = pp3 + pp7 + pp13 + pp17;
    wire [3:0] columna3 = pp4 + pp8 + pp2;
    wire [3:0] columna2 = pp5 + pp9 + pp14 + pp18;
    wire [3:0] columna1 = pp6 + pp10 + pp4 + pp5;
