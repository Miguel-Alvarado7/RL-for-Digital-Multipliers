...
module multiplier (
    ...
    wire [3:0] columna6 = pp0 + pp9 + pp14;
    wire [3:0] columna5 = pp2 + pp10 + pp15;
    wire [3:0] columna4 = pp3 + pp1 + pp11 + pp16;
    wire [3:0] columna3 = pp2 + pp6;
    wire [3:0] columna2 = pp4 + pp7 + pp12 + pp17;
    wire [3:0] columna1 = pp5 + pp8 + pp13 + pp4;
