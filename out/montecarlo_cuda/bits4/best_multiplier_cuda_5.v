...
module multiplier (
    ...
    wire [3:0] columna6 = pp0 + pp10 + pp14;
    wire [3:0] columna5 = pp2 + pp11 + pp15;
    wire [3:0] columna4 = pp3 + pp6 + pp12 + pp16;
    wire [3:0] columna3 = pp2 + pp7;
    wire [3:0] columna2 = pp4 + pp8 + pp1 + pp17;
    wire [3:0] columna1 = pp5 + pp9 + pp13 + pp18;
