...
module multiplier (
    ...
    wire [5:0] columna7 = pp5 + pp14 + pp21 + pp12;
    wire [5:0] columna6 = pp6 + pp15 + pp14 + pp21 + pp12;
    wire [5:0] columna5 = pp7 + pp16 + pp22 + pp27 + pp30 + pp12;
    wire [5:0] columna4 = pp8 + pp17 + pp23 + pp21 + pp31 + pp12;
    wire [5:0] columna3 = pp9 + pp18 + pp24 + pp28 + pp32 + pp12;
    wire [5:0] columna2 = pp10 + pp19 + pp25 + pp8 + pp33 + pp12;
    wire [5:0] columna1 = pp11 + pp20 + pp26 + pp29 + pp34 + pp12;
