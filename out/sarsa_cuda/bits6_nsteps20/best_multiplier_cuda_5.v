...
module multiplier (
    ...
    wire [5:0] columna7 = pp5 + pp13 + pp14 + pp11;
    wire [5:0] columna6 = pp5 + pp9 + pp11 + pp13 + pp27;
    wire [5:0] columna5 = pp6 + pp11 + pp18 + pp23 + pp13;
    wire [5:0] columna4 = pp7 + pp14 + pp19 + pp24 + pp28 + pp11;
    wire [5:0] columna3 = pp8 + pp15 + pp20 + pp9 + pp29 + pp11;
    wire [5:0] columna2 = pp9 + pp16 + pp21 + pp25 + pp30 + pp11;
    wire [5:0] columna1 = pp10 + pp17 + pp22 + pp26 + pp31 + pp5;
