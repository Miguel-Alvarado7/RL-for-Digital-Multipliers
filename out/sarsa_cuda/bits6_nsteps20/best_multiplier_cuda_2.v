...
module multiplier (
    ...
    wire [5:0] columna7 = pp5 + pp14 + pp15 + pp12;
    wire [5:0] columna6 = pp6 + pp10 + pp12 + pp14 + pp28;
    wire [5:0] columna5 = pp7 + pp12 + pp19 + pp24 + pp14;
    wire [5:0] columna4 = pp8 + pp15 + pp20 + pp25 + pp29 + pp12;
    wire [5:0] columna3 = pp9 + pp16 + pp21 + pp10 + pp4 + pp12;
    wire [5:0] columna2 = pp10 + pp17 + pp22 + pp26 + pp30 + pp12;
    wire [5:0] columna1 = pp11 + pp18 + pp23 + pp27 + pp31 + pp5;
