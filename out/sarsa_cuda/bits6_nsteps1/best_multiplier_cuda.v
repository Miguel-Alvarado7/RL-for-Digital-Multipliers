...
module multiplier (
    ...
    wire [5:0] columna6 = pp4 + pp12 + pp10;
    wire [5:0] columna5 = pp5 + pp13 + pp7 + pp10;
    wire [5:0] columna4 = pp6 + pp7 + pp5 + pp10;
    wire [5:0] columna3 = pp7 + pp13 + pp10;
    wire [5:0] columna2 = pp8 + pp13 + pp7 + pp15 + pp6 + pp10;
    wire [5:0] columna1 = pp9 + pp3 + pp14 + pp16 + pp10;
