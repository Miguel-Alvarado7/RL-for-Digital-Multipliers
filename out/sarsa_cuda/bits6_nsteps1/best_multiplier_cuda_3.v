...
module multiplier (
    ...
    wire [5:0] columna8 = pp4 + pp10 + pp9;
    wire [5:0] columna7 = pp4 + pp6 + pp9;
    wire [5:0] columna6 = pp5 + pp11 + pp9 + pp7;
    wire [5:0] columna5 = pp6 + pp9;
    wire [5:0] columna4 = pp7 + pp5 + pp9;
    wire [5:0] columna3 = pp7 + pp10 + pp9;
    wire [5:0] columna2 = pp6 + pp12 + pp14 + pp16 + pp9;
    wire [5:0] columna1 = pp8 + pp13 + pp15 + pp17 + pp18 + pp9;
