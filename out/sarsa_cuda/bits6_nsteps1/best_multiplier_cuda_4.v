...
module multiplier (
    ...
    wire [5:0] columna5 = pp5 + pp7 + pp12 + pp10;
    wire [5:0] columna4 = pp6 + pp12 + pp10;
    wire [5:0] columna3 = pp7 + pp5 + pp10;
    wire [5:0] columna2 = pp8 + pp10 + pp14 + pp16 + pp18;
    wire [5:0] columna1 = pp9 + pp13 + pp15 + pp17 + pp19 + pp10;
