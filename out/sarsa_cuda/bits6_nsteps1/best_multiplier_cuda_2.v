...
module multiplier (
    ...
    wire [5:0] columna8 = pp4 + pp5 + pp11;
    wire [5:0] columna7 = pp5 + pp12 + pp11;
    wire [5:0] columna6 = pp6 + pp13 + pp8 + pp11;
    wire [5:0] columna5 = pp5 + pp12 + pp11;
    wire [5:0] columna4 = pp7 + pp11;
    wire [5:0] columna3 = pp8 + pp14 + pp6 + pp11;
    wire [5:0] columna2 = pp9 + pp15 + pp7 + pp3 + pp19 + pp11;
    wire [5:0] columna1 = pp10 + pp16 + pp17 + pp18 + pp20 + pp11;
