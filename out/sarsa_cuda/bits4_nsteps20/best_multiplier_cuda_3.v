...
module multiplier (
    ...
    wire [3:0] columna6 = pp2 + pp7;
    wire [3:0] columna5 = pp3 + pp8 + pp12;
    wire [3:0] columna4 = pp4 + pp9 + pp13;
    wire [3:0] columna3 = pp5 + pp10 + pp14;
    wire [3:0] columna2 = pp5 + pp11 + pp15;
    wire [3:0] columna1 = pp6 + pp12 + pp5;
