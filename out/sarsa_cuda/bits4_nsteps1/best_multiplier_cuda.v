...
module multiplier (
    ...
    wire [3:0] columna8 = pp0 + pp2;
    wire [3:0] columna7 = pp1 + pp2;
    wire [3:0] columna6 = pp2;
    wire [3:0] columna5 = pp3 + pp2;
    wire [3:0] columna4 = pp4 + pp8 + pp2;
    wire [3:0] columna3 = pp5 + pp2;
    wire [3:0] columna2 = pp6 + pp9 + pp2;
    wire [3:0] columna1 = pp7 + pp10 + pp2;
