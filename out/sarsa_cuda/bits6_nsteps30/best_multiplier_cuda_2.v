...
module multiplier (
    ...
    wire [5:0] columna7 = pp5 + pp18 + pp11;
    wire [5:0] columna6 = pp6 + pp13 + pp18 + pp23 + pp8 + pp11;
    wire [5:0] columna5 = pp7 + pp11 + pp19 + pp23;
    wire [5:0] columna4 = pp8 + pp14 + pp20 + pp23 + pp27 + pp11;
    wire [5:0] columna3 = pp9 + pp15 + pp21 + pp24 + pp5 + pp11;
    wire [5:0] columna2 = pp9 + pp16 + pp12 + pp25 + pp11;
    wire [5:0] columna1 = pp10 + pp17 + pp22 + pp26 + pp5 + pp11;
