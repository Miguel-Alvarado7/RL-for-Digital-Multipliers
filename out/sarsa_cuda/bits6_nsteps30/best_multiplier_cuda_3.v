...
module multiplier (
    ...
    wire [5:0] columna7 = pp5 + pp13 + pp11 + pp28;
    wire [5:0] columna6 = pp6 + pp4 + pp19 + pp11;
    wire [5:0] columna5 = pp7 + pp14 + pp20 + pp24 + pp29 + pp11;
    wire [5:0] columna4 = pp8 + pp15 + pp11 + pp3 + pp12;
    wire [5:0] columna3 = pp0 + pp16 + pp21 + pp25 + pp12 + pp11;
    wire [5:0] columna2 = pp9 + pp17 + pp22 + pp26 + pp30 + pp11;
    wire [5:0] columna1 = pp10 + pp18 + pp23 + pp27 + pp31 + pp11;
