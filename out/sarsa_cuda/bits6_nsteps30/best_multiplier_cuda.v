...
module multiplier (
    ...
    wire [5:0] columna7 = pp5 + pp14 + pp12;
    wire [5:0] columna6 = pp6 + pp14 + pp23 + pp27 + pp12;
    wire [5:0] columna5 = pp7 + pp12 + pp19 + pp24 + pp23;
    wire [5:0] columna4 = pp8 + pp15 + pp20 + pp28 + pp12;
    wire [5:0] columna3 = pp9 + pp16 + pp1 + pp29 + pp12;
    wire [5:0] columna2 = pp10 + pp17 + pp21 + pp25 + pp30 + pp12;
    wire [5:0] columna1 = pp11 + pp18 + pp22 + pp26 + pp31 + pp12;
