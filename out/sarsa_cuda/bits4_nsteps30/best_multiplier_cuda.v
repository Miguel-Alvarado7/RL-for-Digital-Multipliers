...
module multiplier (
    ...
    wire [3:0] columna6 = pp2 + pp6;
    wire [3:0] columna5 = pp3 + pp7 + pp12;
    wire [3:0] columna4 = pp4 + pp8 + pp13;
    wire [3:0] columna3 = pp5 + pp9 + pp14;
    wire [3:0] columna2 = pp5 + pp10 + pp15;
    wire [3:0] columna1 = pp5 + pp11 + pp10;
