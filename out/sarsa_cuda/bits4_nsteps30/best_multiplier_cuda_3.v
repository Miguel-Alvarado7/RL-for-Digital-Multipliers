...
module multiplier (
    ...
    wire [3:0] columna5 = pp3 + pp9 + pp13;
    wire [3:0] columna4 = pp4 + pp6 + pp14;
    wire [3:0] columna3 = pp5 + pp10 + pp12;
    wire [3:0] columna2 = pp6 + pp11 + pp12;
    wire [3:0] columna1 = pp7 + pp12 + pp15;
