...
module multiplier (
    ...
    wire [5:0] columna5 = pp6 + pp12 + pp10;
    wire [5:0] columna4 = pp7 + pp8 + pp10;
    wire [5:0] columna3 = pp8 + pp10 + pp14;
    wire [5:0] columna2 = pp4 + pp10;
    wire [5:0] columna1 = pp9 + pp8 + pp13 + pp10;
