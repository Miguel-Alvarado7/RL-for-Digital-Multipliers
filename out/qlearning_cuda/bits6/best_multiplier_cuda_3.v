...
module multiplier (
    ...
    wire [5:0] columna8 = pp4 + pp6 + pp10;
    wire [5:0] columna7 = pp4 + pp7 + pp10;
    wire [5:0] columna6 = pp5 + pp7 + pp10;
    wire [5:0] columna5 = pp6 + pp11 + pp10 + pp4;
    wire [5:0] columna4 = pp7 + pp12 + pp10 + pp13;
    wire [5:0] columna3 = pp7 + pp12 + pp10;
    wire [5:0] columna2 = pp8 + pp12 + pp10;
    wire [5:0] columna1 = pp9 + pp4 + pp10;
